...
.LFB0:
        ...
        mov     QWORD PTR [rbp-288], OFFSET FLAT:.LC0
        mov     QWORD PTR [rbp-136], OFFSET FLAT:.LC1
        mov     QWORD PTR [rbp-280], OFFSET FLAT:.LC2
        mov     QWORD PTR [rbp-128], OFFSET FLAT:.LC3
        mov     QWORD PTR [rbp-272], OFFSET FLAT:.LC4
        mov     QWORD PTR [rbp-120], OFFSET FLAT:.LC4
        mov     QWORD PTR [rbp-264], OFFSET FLAT:.LC5
        mov     QWORD PTR [rbp-112], OFFSET FLAT:.LC4
        mov     QWORD PTR [rbp-256], OFFSET FLAT:.LC3
        mov     QWORD PTR [rbp-104], OFFSET FLAT:.LC4
        mov     QWORD PTR [rbp-248], OFFSET FLAT:.LC6
        mov     QWORD PTR [rbp-96], OFFSET FLAT:.LC7
        mov     QWORD PTR [rbp-240], OFFSET FLAT:.LC8
        mov     QWORD PTR [rbp-88], OFFSET FLAT:.LC7
        mov     QWORD PTR [rbp-232], OFFSET FLAT:.LC9
        mov     QWORD PTR [rbp-80], OFFSET FLAT:.LC7
        mov     QWORD PTR [rbp-224], OFFSET FLAT:.LC10
        mov     QWORD PTR [rbp-72], OFFSET FLAT:.LC7
        mov     QWORD PTR [rbp-216], OFFSET FLAT:.LC11
        ...
        mov     QWORD PTR [rbp-192], OFFSET FLAT:.LC13
        mov     QWORD PTR [rbp-40], OFFSET FLAT:.LC14
        mov     QWORD PTR [rbp-184], OFFSET FLAT:.LC12
        mov     QWORD PTR [rbp-32], OFFSET FLAT:.LC0
        mov     QWORD PTR [rbp-176], OFFSET FLAT:.LC5
        mov     QWORD PTR [rbp-24], OFFSET FLAT:.LC15
        mov     QWORD PTR [rbp-168], OFFSET FLAT:.LC16
        mov     QWORD PTR [rbp-16], OFFSET FLAT:.LC0
        mov     QWORD PTR [rbp-160], OFFSET FLAT:.LC17
        mov     DWORD PTR [rbp-4], 0
        jmp     .L2
.L3:
        mov     eax, DWORD PTR [rbp-4]
        cdqe
        mov     rdx, QWORD PTR [rbp-288+rax*8]
        mov     eax, DWORD PTR [rbp-4]
        cdqe
