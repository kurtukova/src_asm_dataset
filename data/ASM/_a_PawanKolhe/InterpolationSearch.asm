...
.LFB1:
        ...
        mov     rbp, rsp
        sub     rsp, 80
        mov     DWORD PTR [rbp-80], 10
        mov     DWORD PTR [rbp-76], 12
        mov     DWORD PTR [rbp-72], 13
        mov     DWORD PTR [rbp-68], 16
        mov     DWORD PTR [rbp-64], 18
        mov     DWORD PTR [rbp-60], 19
        mov     DWORD PTR [rbp-56], 20
        mov     DWORD PTR [rbp-52], 21
        mov     DWORD PTR [rbp-48], 22
        mov     DWORD PTR [rbp-44], 23
        mov     DWORD PTR [rbp-40], 24
        mov     DWORD PTR [rbp-36], 33
        mov     DWORD PTR [rbp-32], 35
        mov     DWORD PTR [rbp-28], 42
        mov     DWORD PTR [rbp-24], 47
        mov     DWORD PTR [rbp-4], 15
        mov     DWORD PTR [rbp-8], 18
