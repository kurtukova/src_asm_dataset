...
.L5:
        ...
        ret
.LFE119:
rot128(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > const&):
.LFB1761:
        push    rbp
        mov     rbp, rsp
        push    rbx
...
.LEHE2:
        ...
        mov     rdi, rax
.LEHB3:
        call    rot128(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > const&)
.LEHE3:
...
.L60:
        ...
        ret
.LFE2313:
_GLOBAL__sub_I_rot128(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > const&):
.LFB2314:
        push    rbp
        mov     rbp, rsp
        mov     esi, 65535
