...
.LFE2264:
.LC0:
        .string "Enter a valid file name: "
.LC1:
        .string ""
.LC2:
        .string "Enter a line to append to the file (or -1 to stop): "
.LC3:
        .string "-1"
.LC4:
        .string "\r\n"
.LC5:
        .string "How many times would you like to print the file contents? (1-20): "
.LC6:
        .string "\n"
main:
.LFB2255:
...
.LEHB4:
        ...
        mov     rdi, rax
        call    std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >::find(char const*, unsigned long) const
        cmp     rax, -1
        setne   al
        test    al, al
        je      .L15
