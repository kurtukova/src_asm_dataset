...
.LEHB0:
        ...
        lea     rax, [rbp-608]
        mov     rdi, rax
        call    std::basic_fstream<char, std::char_traits<char> >::basic_fstream() [complete object constructor]
.LEHE0:
        mov     esi, 16
        mov     edi, 8
        ...
        mov     rdi, rax
.LEHB1:
        call    std::basic_fstream<char, std::char_traits<char> >::open(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > const&, std::_Ios_Openmode)
        lea     rax, [rbp-608]
        add     rax, 264
        mov     rdi, rax
...
.L11:
        lea     rax, [rbp-608]
        mov     rdi, rax
        call    std::basic_fstream<char, std::char_traits<char> >::~basic_fstream() [complete object destructor]
        lea     rax, [rbp-64]
        mov     rdi, rax
        call    std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >::~basic_string() [complete object destructor]
        mov     eax, ebx
