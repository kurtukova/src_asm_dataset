...
.LFB1761:
        ...
        mov     DWORD PTR [rbp-8], 226
        mov     DWORD PTR [rbp-12], 1085
...
.LC2:
        .string "-h"
.LC3:
        .string "The math in these methods are virtually irritating.\n"
.LC4:
        .string "Score!\n"
.LC5:
        .string "Fail!\n"
...
.LBB7:
        ...
        mov     eax, OFFSET FLAT:vtable for deriv+16
...
typeinfo for deriv:
        ...
        .quad   typeinfo name for deriv
        .quad   typeinfo for base
typeinfo name for deriv:
        .string "5deriv"
typeinfo for base:
