...
int main(int argc, char* argv[]) {
    ...
    int row1, col1, row2, col2, vals1, vals2;
    printf("Enter in the following order - row1 col1 row2 col2 vals1 vals2: \n");
    scanf("%d %d %d %d %d %d", &row1, &col1, &row2, &col2, &vals1, &vals2);
    struct node* head1 = NULL;
    struct node* head2 = NULL;
    struct node* head3 = NULL;
    create(&head1, row1, col1, vals1);
    create(&head2, row2, col2, vals2);
