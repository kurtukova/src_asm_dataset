...
D887 - Wild Pok�mon encounter rates

Common Battles:

    D888 - Level of Encounter 1
    D889 - Pok�mon Data Value 1
    D88A - Level of Encounter 2
    D88B - Pok�mon Data Value 2
    D88C - Level of Encounter 3
    D88D - Pok�mon Data Value 3
    D88E - Level of Encounter 4
    D88F - Pok�mon Data Value 4

Uncommon Battles:

    D890 - Level of Encounter 1
    D891 - Pok�mon Data Value 1
    D892 - Level of Encounter 2
    D893 - Pok�mon Data Value 2
    D894 - Level of Encounter 3
    D895 - Pok�mon Data Value 3
    D896 - Level of Encounter 4
    D897 - Pok�mon Data Value 4

Rare Battles:

    D898 - Level of Encounter 1
    D899 - Pok�mon Data Value 1
    D89A - Level of Encounter 2 
    D89B - Pok�mon Data Value 2

Opponent Trainer�s Pok�mon

    D89C - Total enemy Pok�mon
    D89D - Pok�mon 1
    D89E - Pok�mon 2
    D89F - Pok�mon 3
    D8A0 - Pok�mon 4
...
This is for the current box that's in use.
    ...
    DA80 - Number of Pok�mon in current box
    DA81-CA94 - Pok�mon 1-20
    DA95 - End of list
