...
void reverse_display_2(struct node *head){
    struct node *curr;
    int arr[100];
    int n = 0;
...
int main(){
    ...
    // printf("The data stored in the linked list (Reversed order) is:\n");
    // reverse_display(head);

    printf("The data stored in the linked list (Reversed order 2nd func) is:\n");
    reverse_display_2(head);
}